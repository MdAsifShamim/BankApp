...
@Tag(name = "CRUD REST APIs for Loan in Bank Application",
        description = "CRUD REST APIs in Bank to CREATE,UPDATE,FETCH,DELETE Loan Details")
//@AllArgsConstructor
@Validated
public class LoansController {
    ...
    public ResponseEntity<ResponseDto> createLoan(@RequestParam
        ...
        iLoansService.createLoan(phoneNumber);
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoanDto> fetchLoanDetail(@RequestHeader("mybank-correlation-id") String correlationId,@RequestParam
