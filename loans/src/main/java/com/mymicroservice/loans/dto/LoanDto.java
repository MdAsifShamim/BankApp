package com.mymicroservice.loans.dto;
...
public class LoanDto {
    ...
    @NotEmpty(message = "Mobile Not not be null or empty")
    @Pattern(regexp = "^$|[0-9]{10}",message = "Mobile number must be 10 character digit")
    @Schema(
