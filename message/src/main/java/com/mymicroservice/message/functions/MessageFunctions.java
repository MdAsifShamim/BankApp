package com.mymicroservice.message.functions;

import com.mymicroservice.message.dto.AccountMsgDto;
...
public class MessageFunctions {
    ...
    public Function<AccountMsgDto,Long> sms(){
        return accountMsgDto->{
          log.info("Sednign sms with the details : "+accountMsgDto.toString());
